...
public class main extends Activity {
    ...
    public boolean FirstTimeIntro(){
        ...
        editor.putBoolean("com.example.cardbook.Introconfirmation", true);
        editor.commit();

        boolean Flag = sharedPref.getBoolean("com.example.cardbook.Introconfirmation",true);
        //settings.edit().putBoolean("FirstTime_OnlyOnce", false).commit();
        if (Flag) {
            //the app is being launched for first time, do something
            // record the fact that the app has been started at least once
            editor.putBoolean("com.example.cardbook.Introconfirmation", false);
            editor.commit();
            return true;
        }else{
            return false;
